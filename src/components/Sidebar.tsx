...
export default function Sidebar({ user, hasApprovals, isAuthenticatedButNotInMaster = false, authenticatedEmail }: SidebarProps) {
    ...
    if (isAuthenticatedButNotInMaster) {
        return (
            <aside className="fixed left-0 top-0 w-64 bg-slate-800 text-white p-6 flex flex-col shadow-xl border-r border-gray-700 z-10 h-screen">
                <div className="mb-6">
    ...
    return (
        <aside className="fixed left-0 top-0 w-64 bg-slate-800 text-white h-screen flex flex-col shadow-xl border-r border-gray-700 z-10">
